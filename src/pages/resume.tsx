      ...
      <article className={styles.page}>
        ...
        <section className={styles.rightSide}>
          <p className={styles.aboutMe}>
            ...
            web, design, data visualization, and mobile SW development.
          </p>
          <dl>
            <dt>Education</dt>
            <dd className={styles.dd}>
              ...
              <p>
                <strong>Major:</strong> Computer Engineering and Computer
                Science
                <br />
            ...
            <dd className={styles.dd}>
              ...
              <p>
                Software Design, UI/UX, Javascript/Typescript, Any flavor of
                CSS, HTML, SVG
              </p>
              <h2 className={styles.h2}>Computer skills</h2>
              <p>
                Comfortable designing things with Figma, Adobe Creative Suite,
                and Sketch
              </p>
            ...
            <dd className={styles.dd}>
              ...
              <p>
                ...
                infrastructure and services to support ML engineers. Engine ML
                empowers any ML team to be able to rapidly build state of the
                art models by leveraging GPU-enabled computation.
              </p>
              <p>
              ...
              <ul className={styles.ul}>
                <li>
                  Built Engine ML's UI and application backend from the ground
                  up using modern best practices. The sole engineer designing
                  and working on the UI and its corresponding backends.
                </li>
                <li>
                  Re-architected the application to support collaborative
                  paradigms like teams and projects with proper access control.
                  Added support for user and team slugs to enable intuitive URLs
                  and navigation.
                </li>
                <li>
                ...
                <li>
                  ...
                  authentication and authorization. Migrated the UI from using
                  REST to GraphQL.
                </li>
                <li>
                  Converted the UI to be fully live-updating with the careful
                  use of GraphQL subscriptions and polling
                </li>
                <li>
                  Crafted various custom components to support various
                  use-cases. These included a live log viewer with ANSI
                  character highlighting, a file browser, top-level application
                  search with hot-key support, code snippets with syntax
              ...
              <p className={styles.p}>
                ...
                human interface design, and iOS engineers to ship and maintain
                iOS features.
              </p>
              <p className={styles.p}>
              ...
              <p className={styles.p}>
                UI engineer in a small but highly versatile engineering team
                that worked on Visual TruView, an industry leading application
                and network performance monitoring tool. After joining the team,
                the product was transformed from being a struggling business
                venture for Fluke Networks into a highly successful,
                award-winning product that was considered a cornerstone of Fluke
                Networks’ success.
              </p>
              <ul className={styles.ul}>
                <li>
                  Designed and programmed various features and user experience
                  improvements that resulted in an industry-leading UI according
                  to Gartner Research (2 years in a row).
                </li>
                <li>
                  Created the first ever AANPM mobile app. Was the sole engineer
                  responsible for this project: designed, architected, and
                  implemented the application from the ground up. I created a
                  custom communication protocol that allows TruView customers to
                  securely access their private data center data from outside of
                  their company's firewall. Technologies used include: Node,
                  PubNub, Sencha Touch, D3, CSS animations, Parse.js, Cordova,
                  and Crypto JS.
                </li>
                <li>
                  Pioneered the use of user-centered design principles and
                  practices within the company.
                </li>
                <li>
                  Fulfilled a variety of roles that include UI programmer,
                  designer, software architect, NodeJS developer, recruiter, UX
                  consultant, and mobile technology consultant.
                </li>
              </ul>
              <h2 className={styles.h2}>
            ...
            <dd className={styles.dd}>
              ...
              <p className={styles.p}>
                Upsilon Phi Epsilon (Computer Science Honors Society), Tau Beta
                Pi Delta (Engineering Honors Society), Epsilon Kappa Nu
                (Electrical and Computer Engineering Honors Society), Phi Kappa
                Phi (Nation's oldest, largest, and most selective all-discipline
                honor society), Alpha Lambda Delta (National Academic Honors
            ...
            <dd className={styles.dd}>
              I enjoy rock climbing, snowboarding, biking, surfing, woodworking,
              and printmaking.
            </dd>
          </dl>
        </section>
